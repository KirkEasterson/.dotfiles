...
vim.keymap.set({ "n" }, "[c", function()
  require("gitsigns").nav_hunk("prev", { wrap = true, navigation_message = false, target = "all" })
end, { desc = "Prev hunk" })
vim.keymap.set({ "n" }, "]c", function()
  require("gitsigns").nav_hunk("next", { wrap = true, navigation_message = false, target = "all" })
end, { desc = "Next hunk" })
vim.keymap.set({ "n" }, "[C", function()
  require("gitsigns").nav_hunk("first", { navigation_message = false, target = "all" })
end, { desc = "First hunk" })
vim.keymap.set({ "n" }, "]C", function()
  require("gitsigns").nav_hunk("last", { navigation_message = false, target = "all" })
end, { desc = "Last hunk" })
