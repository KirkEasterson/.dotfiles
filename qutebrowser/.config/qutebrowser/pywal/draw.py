...
home = str(Path.home())
with open(f'{home}/.cache/wal/colors-speedcrunch.json', 'r') as file:
    colorjson = json.load(file)


palette = {
    'background': colorjson["background"],
    'background-alt': colorjson["background"],
    'background-attention': colorjson["cursor"],
    'border': colorjson["background"],
    'current-line': colorjson["separator"],
